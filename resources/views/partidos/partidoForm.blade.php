                    ...
                    <div class="col-md-6">
                        <select name="jornada_id" class="form-control">
                            ...
                            <option value="{{ $jornada->id }}"
                                {{ isset($partido) && $partido->jornada_id == $jornada->id ? 'selected' : '' }}>
                                {{ $jornada->numero }}</option>
                            @endforeach
                            @endif
                        </select>
                    ...
                    <div class="col-md-6">
                        <select name="equipo_local" class="form-control">
                            ...
                            <option value="{{ $equipo->id }}"
                                {{ isset($partido) && $partido->equipo_local == $equipo->id ? 'selected' : '' }}>
                                {{ $equipo->id }} - {{ $equipo->nombre }}</option>
                            @endforeach
                        </select>
                    </div>
                </div>
                <div class="form-group row">
                    ...
                    <div class="col-md-6">
                        <select name="equipo_visitante" class="form-control">
                            @foreach($equipos as $equipo)
                            <option value="{{ $equipo->id }}"
                                {{ isset($partido) && $partido->equipo_visitante == $equipo->id ? 'selected' : '' }}>
                                {{ $equipo->id }} - {{ $equipo->nombre }}</option>
                            @endforeach
                        </select>
                    </div>
